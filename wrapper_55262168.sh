...
#SBATCH -o tbss_logs/dwi_non_FA_array.o%A.%a
#SBATCH -e tbss_logs/dwi_non_FA_array.e%A.%a
#SBATCH --mem=64G
#SBATCH -t 239
#SBATCH --job-name=dwi_non_FA_array
...
# Command line: /gpfs/home/rf2485/.conda/envs/fsl_eddy/bin/fsl_sub -T 239 -R 64 -l tbss_logs -t /gpfs/data/lazarlab/CamCan995//derivatives/scd/main//dwi_non_FA_array
# Submission time (H:M:S DD/MM/YYYY): 17:52:38 26/11/2024


the_command=$(sed -n -e "${SLURM_ARRAY_TASK_ID}p" /gpfs/data/lazarlab/CamCan995//derivatives/scd/main//dwi_non_FA_array)
