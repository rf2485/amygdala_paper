...
mask_list=( brain_mask csf_mask FWF_mask ODI_mask mk_mask )
...
#generate QC webpages for NODDI metrics (wm and gm)
noddi_list=( wm_fit_FWF wm_fit_NDI wm_fit_ODI )
mkdir -p $dwidir/group_qc/AMICO/NODDI
for i in "${noddi_list[@]}"; do
	if [ ! -f $dwidir/group_qc/$i/index.html ]; then
		slicesdir $t1dir/*/diffusion/${i}.nii.gz
		rm -rf $dwidir/group_qc/AMICO/NODDI/$i
		mv slicesdir $dwidir/group_qc/AMICO/NODDI/$i
	fi
done
...
if [ ! -f $t1dir/group_qc/jhu2diff/index.html ]; then
	...
	for subj in "${subj_list[@]}"; do
		if [ ! -f $t1dir/group_qc/jhu2diff/$subj.png ]; then
			freeview -v $t1dir/$subj/diffusion/B0.nii $t1dir/$subj/diffusion/jhu2diff_wm_NODDI_mask.mgz:colormap=lut:opacity=0.2 -viewport 'x' -slice 38 48 33 -nocursor -screenshot $t1dir/group_qc/jhu2diff/grota.png
			freeview -v $t1dir/$subj/diffusion/B0.nii $t1dir/$subj/diffusion/jhu2diff_wm_NODDI_mask.mgz:colormap=lut:opacity=0.2 -viewport 'x' -slice 48 48 33 -nocursor -screenshot $t1dir/group_qc/jhu2diff/grotb.png
			freeview -v $t1dir/$subj/diffusion/B0.nii $t1dir/$subj/diffusion/jhu2diff_wm_NODDI_mask.mgz:colormap=lut:opacity=0.2 -viewport 'x' -slice 58 48 33 -nocursor -screenshot $t1dir/group_qc/jhu2diff/grotc.png
			freeview -v $t1dir/$subj/diffusion/B0.nii $t1dir/$subj/diffusion/jhu2diff_wm_NODDI_mask.mgz:colormap=lut:opacity=0.2 -viewport 'y' -slice 48 38 33 -nocursor -screenshot $t1dir/group_qc/jhu2diff/grotd.png
			freeview -v $t1dir/$subj/diffusion/B0.nii $t1dir/$subj/diffusion/jhu2diff_wm_NODDI_mask.mgz:colormap=lut:opacity=0.2 -viewport 'y' -slice 48 48 33 -nocursor -screenshot $t1dir/group_qc/jhu2diff/grote.png
			freeview -v $t1dir/$subj/diffusion/B0.nii $t1dir/$subj/diffusion/jhu2diff_wm_NODDI_mask.mgz:colormap=lut:opacity=0.2 -viewport 'y' -slice 48 58 33 -nocursor -screenshot $t1dir/group_qc/jhu2diff/grotf.png
			freeview -v $t1dir/$subj/diffusion/B0.nii $t1dir/$subj/diffusion/jhu2diff_wm_NODDI_mask.mgz:colormap=lut:opacity=0.2 -viewport 'z' -slice 48 48 26 -nocursor -screenshot $t1dir/group_qc/jhu2diff/grotg.png
			freeview -v $t1dir/$subj/diffusion/B0.nii $t1dir/$subj/diffusion/jhu2diff_wm_NODDI_mask.mgz:colormap=lut:opacity=0.2 -viewport 'z' -slice 48 48 33 -nocursor -screenshot $t1dir/group_qc/jhu2diff/groth.png
			freeview -v $t1dir/$subj/diffusion/B0.nii $t1dir/$subj/diffusion/jhu2diff_wm_NODDI_mask.mgz:colormap=lut:opacity=0.2 -viewport 'z' -slice 48 48 40 -nocursor -screenshot $t1dir/group_qc/jhu2diff/groti.png
